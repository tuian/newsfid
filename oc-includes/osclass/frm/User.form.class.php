...
class UserForm extends Form {
    ...
    static public function birthday_text($user = null) {
        parent::generic_input_text("s_birthday", isset($user['s_birthday']) ? $user['s_birthday'] : '', null, false);
    }
        ...
        <script type="text/javascript">
            ...
            required: true
                    ...
                    required: "<?php _e("Name: this field is required"); ?>."
                            ...
                            s_birthday: {
                                required: "<?php _e("Birthday: this field is required"); ?>"
                            }
                    },
