...
function osc_slider() {
    ...
    <div id="sliders"<?php if (ModelSlider::newInstance()->getSlider()) { ?> class="slidefix"<?php } ?>>	
        <div class="rslides_container" id="cover-bg">
                        ...
                        <?php if (getSliderCaption() == 1) { ?>
                            <div class="carousel-caption">
                                ...
                                <h1 style="font-size: 15px; color: #F2F2F2; font-family: Verdana;">  HEADLINES <h1> 
                                        ...
                                        <h1><?php echo $slide['s_title']; ?></h1>

                                        <?php
                                        $string = strip_tags(isset($slide['s_description']) ? $slide['s_description'] : '');
...
// make sure it ends in a word so assassinate doesn't become ass...
                                            $string = substr($stringCut, 0, strrpos($stringCut, ' ')) . ' <div class="col-md-12 green padding-0 item_title_head read_more" data_item_id="' . $slide['fk_i_item_id'] . '"> Read More </div>';
                                        }
                                        ?>  <?php echo $string;
                                        ?></i>
                            ...
                            function slider_js_Head() {
                                ...
                                <style type="text/css">
                                    #sliders{
                                        ...
                                        <?php
                                        if (getSliderWidth() != 0) {
                                            echo 'width: ' . getSliderWidth() . 'px';
                                        }
                                        ?>
                                    }
                                    .rslides img {
                                        <?php
                                        if (getSliderHeight() == 0) {
                                            echo 'height: 100%;';
                                        } else {
                                            echo 'height: ' . getSliderHeight() . 'px';
                                        }
                                        ?>
                                    }
                                </style>
