...
<?php foreach($slides as $slide) { ?>
	...
	<td><a href="<?php echo osc_admin_render_plugin_url("slider/edit.php").'?actions=edit&id='.$slide['id']; ?>"><?php _e('Edit', 'Slider'); ?></a> | <a onclick="javascript:return confirm('<?php _e('Are you sure you want to continue?', 'Slider'); ?>')" href="<?php echo osc_admin_render_plugin_url("slider/edit.php").'?actions=delete&id='.$slide['id']; ?>"><?php _e('Delete' ,'Slider'); ?></a></td>
