...
if(Params::getParam('pub')!='') {
    ...
    if($item['fk_i_user_id']==null || ($item['fk_i_user_id']!=null && $item['fk_i_user_id']==osc_logged_user_id())) {
        ...
        if (isset($category_fee['price']) && $category_fee['price'] > 0) {
            payment_pro_cart_add('PUB' . $item['fk_i_category_id'] . '-' . $item['pk_i_id'], sprintf(__('Publish fee for listing %d', 'payment_pro'), $item['pk_i_id']), $category_fee['price'], 1, osc_get_preference('default_tax', 'payment_pro')/*$category_fee['tax']*/);
...
if(Params::getParam('top')!='') {
    ...
    if($item['fk_i_user_id']==null || ($item['fk_i_user_id']!=null && $item['fk_i_user_id']==osc_logged_user_id())) {
        ...
        if (isset($category_fee['price']) && $category_fee['price'] > 0) {
            payment_pro_cart_add('TOP' . $item['fk_i_category_id'] . '-' . $item['pk_i_id'], sprintf(__('Move to top listing %d', 'payment_pro'), $item['pk_i_id']), $category_fee['price'], 1, osc_get_preference('default_tax', 'payment_pro')/*$category_fee['tax']*/);
...
if(Params::getParam('hlt')!='') {
    ...
    if($item['fk_i_user_id']==null || ($item['fk_i_user_id']!=null && $item['fk_i_user_id']==osc_logged_user_id())) {
        ...
        if (isset($category_fee['price']) && $category_fee['price'] > 0) {
            payment_pro_cart_add('HLT' . $item['fk_i_category_id'] . '-' . $item['pk_i_id'], sprintf(__('Highlight enchancement for listing %d', 'payment_pro'), $item['pk_i_id']), $category_fee['price'], 1, osc_get_preference('default_tax', 'payment_pro')/*$category_fee['tax']*/);
