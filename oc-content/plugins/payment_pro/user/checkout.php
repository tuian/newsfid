            ...
            <?php if ($showWalletButton) { ?>
                <ul class="payments-ul">
                    <?php if(isset($wallet['i_amount']) && $wallet['i_amount']>=$wTotal) {
                        ...
                        echo '<br /><span>';
                        printf(__('You have %s credits in your account, after the purchase you will have %s', 'payment_pro'), payment_pro_format_price($wallet['i_amount'], osc_get_preference('currency', 'payment_pro')), payment_pro_format_price(($wallet['i_amount']-$wTotal), osc_get_preference('currency', 'payment_pro')));
                        echo '</span>';
                    } else {
