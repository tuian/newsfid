...
$opt = '<div class="payments-box">' .
        ...
        '<div class="payments-box-footer">' .
            '<label><input type="checkbox" name="payment_pro_make_premium" id="payment_pro_make_premium" value="1" /> ' . sprintf(__('Make this ad premium (+%s)', 'payment_pro'), osc_format_price($payment_pro_premium_fee['price']*1000000, osc_get_preference('currency', 'payment_pro'))) . '</label>' .
        '</div>' .
    '</div>';
    $pay_opt[] = $opt;
}
...
$opt = '<div class="payments-box">' .
        ...
        '</div>' .
        '<div class="payments-box-footer">' .
            '<label><input type="checkbox" name="payment_pro_make_highlight" id="payment_pro_make_highlight" value="1" /> ' . sprintf(__('Highlight this ad (+%s)', 'payment_pro'), osc_format_price($payment_pro_highlight_fee['price']*1000000, osc_get_preference('currency', 'payment_pro'))) . '</label>' .
        '</div>' .
    '</div>';
    $pay_opt[] = $opt;
}
...
$opt = '<div class="payments-box">' .
        ...
        '<div class="payments-box-footer">' .
            '<label><input type="checkbox" name="dummy_check" id="dummy_check" value="1" checked="checked" disabled="disabled" /> ' . sprintf(__('Publishing this ad costs %s', 'payment_pro'), osc_format_price($payment_pro_publish_fee['price']*1000000, osc_get_preference('currency', 'payment_pro'))) . '</label>' .
        '</div>' .
    '</div>' .
    '</div>';
    $pay_opt[] = $opt;
