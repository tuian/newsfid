                ...
                <tr>
                    ...
                    <td>
                        <a class="delete"
                           ...
                           href="<?php echo osc_admin_render_plugin_url(RUBRIC_PLUGIN_DIR_NAME . '/admin.php') . '&delete=' . $r['id']; ?>">
                               <?php _e('Delete', 'home_gallery'); ?>
                        </a>
                        
                        &nbsp;&nbsp;
                        
                        <a class="delete" href="<?php echo osc_admin_render_plugin_url(RUBRIC_PLUGIN_DIR_NAME . '/admin_edit.php') . '&rubric_id=' . $r['id']; ?>">
