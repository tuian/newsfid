...
<?php   $checked = ($value == 'checked') ? " checked='checked'" : ''; ?>
				...
				<?php _e('Check to show listings', CA_PLUGIN_NAME); ?>
...
<?php } elseif ($type == 'text') { ?>
			...
			<div class='price-slide'>
				<input placeholder="Min:" class="form-control pull-left" type='text' name='<?php echo $name_min; ?>' value='<?php echo $value_min; ?>' />	
				<input placeholder="Max:" class="form-control pull-right" type='text' name='<?php echo $name_max; ?>' value='<?php echo $value_max; ?>' />	
			</div>
			<?php } else { ?>
