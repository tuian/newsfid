        ...
        if ( osc_is_web_user_logged_in() ) {
            ...
            if (!isset($detail['fk_i_item_id'])) {
                ...
                ?>
                    ...
                    <a href="<?php echo osc_base_url(true); ?>?page=custom&file=watchlist/watchlist.php" title="<?php _e('View your watchlist', 'watchlist') ?>">
                ...
                echo '<a href="' . osc_base_url(true) . '?page=custom&file=watchlist/watchlist.php" title="'. __('View your watchlist', 'watchlist').'"><i class="fa fa-check fa-stack-1x fa-inverse"></i></a>';
            }
        } else {
