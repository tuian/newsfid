 ...
 */
	...
	function watchlist2() {
		//echo '<span class="fa-stack fa-lg">';
		echo '<a href="javascript://" class="watchlist2" id="' . osc_item_id() . '" title="' . __('Add to watchlist', 'watchlist') . '" rel="nofollow"><i class="fa fa-heart-o fa-lg"></i></a>';
		//echo '</span>';
	}				
    /*function watchlist() {
    ...
    function watchlist_footer() {
		...
		echo 'var watchlist_url2 = "' . osc_ajax_plugin_url('watchlist/ajax_watchlist2.php') . '";';
        echo '</script>';
