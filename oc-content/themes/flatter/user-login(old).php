    	...
    	<div class="row">
            ...
            <h2><?php _e('Access to your account', 'flatter'); ?></h2>
              ...
              <span>
                           ...
                           <center>
    <img src="images/newsfidlogo.png" alt="logo"  /> 
</center>
      </span>
       <br><br>
            ...
            <form action="<?php echo osc_base_url(true); ?>" name="login" id="login" method="post" >
                    ...
                    <?php if (function_exists("fbc_button")) { ?>
                        ...
                        <?php fbc_button(); ?>
                    <?php } ?>
                    <div class="panel-footer" style="font-size: 11px;"><a href="<?php echo osc_register_account_url(); ?>"><?php _e("Register for a free account", 'flatter'); ?></a>
