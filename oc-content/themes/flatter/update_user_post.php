        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="large-modal">
                ...
                <div class="modal-content">
                    <form method="post" action="<?php echo osc_current_web_theme_url('post_update.php'); ?>" enctype="multipart/form-data">
                            ...
                            <div class="genral-info bg-white border-radius-10">
                                ...
                                <div class="center-contant">
                                    ...
                                    <div class="input-text-area margin-top-20 left-border box-shadow-none width-60">
                                        <input type="text" placeholder="Title" name="p_title" value="<?php echo osc_item_title(); ?>">
                                    </div>
                                    <div class="box-shadow-none width-90 description-box">
                                        <textarea placeholder="Redigez la description ici..." name="p_disc"><?php echo osc_item_description(); ?></textarea>
                                    </div>
