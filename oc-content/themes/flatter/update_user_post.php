                            ...
                            <div class="genral-info bg-white border-radius-10">
                                ...
                                <div class="center-contant">
                                    ...
                                    <div class="box-shadow-none width-90 description-box">
                                        <textarea placeholder="Redigez la description ici..." class="p_disc" name="p_disc"><?php echo $post_desc['s_description'] ?></textarea> <span class="error-desc red">Post Description Required</span>
                                    </div>
