...
<div class="container">
		<div>
			<img class="img-circle" id="avatar-edit-img" height="128" data-src="<?php echo osc_current_web_theme_url() . "/images/user-default.jpg" ?>"  data-holder-rendered="true" style="width: 140px; height: 140px;" src="<?php echo osc_current_web_theme_url() . "/images/user-default.jpg" ?>"/>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="cropimage" method="post" enctype="multipart/form-data" action="<?php echo osc_current_web_theme_url() .'profile.php' ?>">
...
<div id="update-cover" class="collapse">
    <form id="upload_form" enctype="multipart/form-data" method="post" action="<?php echo osc_current_web_theme_url() . 'upload.php' ?>" onsubmit="return checkFormCover()">
        ...
        <!--<div class="col-md-12 background-white"><?php _e("Please select image file", 'flatter') ?></div>-->
        <div class="choose-file col-md-11 margin-left-4per background-white btn btn-info"><span><?php _e("Choose your cover image", "flatter") ?></span><input type="file" name="file_cover_img" class="col-md-12" id="image_file_cover" onchange="fileSelectHandlerCover()" /></div>

        <div class="error"></div>
        <div id="loader-icon_cover" style="display:none;"><img src="<?php echo osc_current_web_theme_url() . '/images/loader.gif' ?>" /></div>
        <div class="step2 col-md-12">
            ...
            <div class="info">
                ...
                <div class="col-md-offset-4 col-sm-offset-4 col-md-4 col-sm-4 padding-bottom-10 padding-top-10"><input type="submit" class="btn btn-info upload_profile_img" style="display: none" value="Upload" /></div>
            </div>
        </div>
    </form> 
</div>
...
<!-- end profil cover -->
<div id="update-avatar" class="collapse">
    <form id="upload_avatar" enctype="multipart/form-data" method="post" action="<?php echo osc_current_web_theme_url() . 'upload.php' ?>" onsubmit="return checkForm()">
        <!-- hidden crop params -->
        ...
        <input type="hidden" id="y2" name="y2" />
                        ...
                        <!--<div class="col-md-12"><?php _e("Please select image file", 'flatter') ?></div>-->
        <div class="choose-file col-md-11 margin-left-4per btn btn-info"><span><?php _e("Choose your Avatar", "flatter"); ?></span><input type="file" name="image_file" class="col-md-12" id="image_file" onchange="fileSelectHandler()" /></div>
        ...
        <div class="step2 col-md-12">
            ...
            <div class="info">
                ...
                <input type="hidden" id="filedimr" name="filedim" />
                <input type="hidden" id="w" name="w" />
                <input type="hidden" id="h" name="h" />
                <div class="col-md-offset-4 col-sm-offset-4 col-md-4 col-sm-4 padding-bottom-10 padding-top-10"><input type="submit" class="btn btn-info upload_profile" style="display: none" value="Upload" /></div>
            </div>
        </div>
    </form> 
</div>
                                ...
                                <?php if (osc_user_id() == osc_logged_user_id()): ?>
                                    <span class="profile_img_overlay">
                                        <div class="file_upload">
                                            <span class ="icon" data-toggle="collapse" data-target="#update-avatar">
                                                <i class="fa fa-camera"></i>
                                            </span>
                                        </div>
                                        <!-- Modal -->
...
//                    alert('ff');
                ...
                jQuery('#btn-crop').on('click', function (e) {
                    e.preventDefault();
                    params = {
                        targetUrl: '<?php echo osc_current_web_theme_url() .'profile.php' ?>?action=save',
                        action: 'save',
