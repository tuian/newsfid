    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 page-title">
                <h1><?php if ($edit) { ?> <?php _e('Edit your story', 'flatter'); ?> <?php } else { ?> <?php _e('Share us your story', 'flatter'); ?> <?php } ?></h1>

                <?php if (osc_get_preference('position9_enable', 'flatter_theme') != '0') { ?>
                    <div id="position-widget"<?php if (osc_get_preference('position9_hide', 'flatter_theme') != '0') {
...
<?php } ?>
                        <div class="generalbox">
                            <h2><?php _e('  ', 'flatter'); ?><?php //_e('Publish a news', 'flatter');  ?></h2>
                            ...
                            <span>
                                ...
                                <img src="images/itempost.jpg" alt="selcome" /> 
...
<?php if (osc_price_enabled_at_items()) { ?>
                        ...
                        <div class="locationbox">
                            <h2><?php _e('News location', 'flatter'); ?></h2>
    ...
    <?php ItemForm::contact_email_text(); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <div class="checkbox">
                                            <label>
                                <?php ItemForm::show_email_checkbox(); ?> <?php _e('Show e-mail on the News page', 'flatter'); ?>
                                            </label>
                                        </div>
                                    </div>
                                </div>
...
<?php } ?>
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
                                    <button type="submit" class="btn btn-clr"><?php if ($edit) {
    _e("Update", 'flatter');
} else {
    _e("Publish it now", 'flatter');
} ?></button>
                                </div>
                            </div>
                        </div>
            ...
            <?php if (osc_get_preference('position10_enable', 'flatter_theme') != '0') { ?>
                <div id="position_widget"<?php if (osc_get_preference('position10_hide', 'flatter_theme') != '0') {
                echo"class='hidden-xs'";
            } ?>>
                    <div class="col-md-12">
