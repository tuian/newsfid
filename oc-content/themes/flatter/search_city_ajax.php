...
$city_data = new DAO();
$city_data->dao->select("city.pk_i_id as city_id, city.s_name as city_name, country.s_name as country_name, country.pk_c_code, region.s_name as region_name, region.pk_i_id ");
