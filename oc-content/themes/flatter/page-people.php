...
<div id="columns">
    ...
    <div class="location_filter_container pull-right pull-right-search">
        <ul class="nav">
            <li class="active location_filter_tab" data_location_type="world" data_location_id=''><a href="#"><?php _e("WORLD", 'flatter') ?></a></li>
            <li class="location_filter_tab" data_location_type="country" data_location_id="<?php echo $logged_user['fk_c_country_code'] ?>"><a href="#"><?php _e("NATIONAL", 'flatter') ?></a></li>
            <li class="location_filter_tab" data_location_type="city" data_location_id="<?php echo $logged_user['fk_i_city_id'] ?>"><a href="#"><?php _e("LOCAL", 'flatter') ?></a></li>
        </ul>
...
function custom_script() {
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            $(document).on('keydown', '.search_name', function () {
                filter_user_search_data();
            });
