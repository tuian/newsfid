...
<div class="soundpass-page bg-white">
    <div class="cover-img">
        <div class="container">
            ...
            <div class="col-md-8">                
                <h1 class="font-color-white bold-600 font-65px">Sound Pass</h1>                
                <h5 class="font-color-white">Lorem Ipsum is simply dummy text</h5>                
            </div>
        </div>
    </div>
    <div class="row padding-0 col-md-offset-1">
        <div class="contant  col-md-12">
            ...
            <div class="col-md-4 padding-top-4per text-center">
                <button type="submit" class="btn btn-lg button-orng-box" data-toggle="modal" data-target="#payment">Activer sound Pass</button>
            </div>                
