...
?>
<div class="listing-card col-md-4 col-sm-6 col-xs-6<?php echo $class; if(osc_item_is_premium()){ echo ' Sponsored'; } ?>  wow fadeInUp animated">
	<div class="clearfix">
	<div class="listing-image">
    	<div class="image">
        	...
        	<?php if(osc_count_premium_resources()) { ?>
                ...
                <a href="<?php echo osc_premium_url(); ?>" title="<?php echo osc_premium_title(); ?>"style="font-weight: bold; font-size: 28px "  ><img src="<?php echo osc_resource_preview_url(); ?>" alt="<?php echo osc_premium_title() ; ?>" class="img-responsive" /></a>
            <?php } else { ?>
                <a href="<?php echo osc_premium_url(); ?>" title="<?php echo osc_premium_title(); ?>"style="font-weight: bold; font-size: 28px "  ><img src="<?php echo osc_current_web_theme_url('images/no-photo.jpg'); ?>" alt="<?php echo osc_premium_title() ; ?>" class="img-responsive" /></a>
            <?php } ?>
        	<?php } ?>
    	</div>
    ...
    <div class="listing-detail">
    	<h5 class="sclr"><a href="<?php echo osc_premium_url() ; ?>" class="title" title="<?php echo osc_premium_title() ; ?>" style="font-weight: bold; font-size: 28px "  ><?php echo osc_premium_title() ; ?></a></h5>
        ...
        <div class="listing-option">
            <?php if($admin) { ?>
                <span class="admin-options">
                    <a class="edit" href="<?php echo osc_premium_edit_url(); ?>" rel="nofollow"><i class="fa fa-pencil"></i> <?php _e('Edit Storie', 'flatter'); ?></a>
