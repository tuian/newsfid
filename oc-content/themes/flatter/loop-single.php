...
<div class="listing-card col-md-4 col-sm-6 col-xs-6<?php echo $class; if(osc_item_is_premium()){ echo ' premium'; } ?>  wow fadeInUp animated">
	...
	<div class="listing-image">
    	<div class="image">
        	...
        	<?php if(osc_count_item_resources()) { ?>
                <a  href="<?php echo osc_item_url();  ?>" style="font-weight: bold; font-size: 21px;" title="<?php echo osc_item_title(); ?>"><img src="<?php echo osc_resource_preview_url(); ?>" alt="<?php echo osc_item_title() ; ?>" class="img-responsive" /></a>
            <?php } else { ?>
                <a href="<?php echo osc_item_url(); ?>" title="<?php echo osc_item_title(); ?>" style="font-weight: bold; font-size: 21px; " ><img src="<?php echo osc_current_web_theme_url('images/no-photo.jpg'); ?>" alt="<?php echo osc_item_title() ; ?>" class="img-responsive" /></a>
            <?php } ?>
        	<?php } ?>
    	</div>
        <?php if(osc_item_is_premium()){ ?><div class="status sbg"><span class="premium"><?php _e('Sponsored', 'flatter'); ?></span></div><?php } ?>
    ...
    <div class="listing-detail">
    	<h5 class="clr"><a href="<?php echo osc_item_url() ; ?>" class="title" title="<?php echo osc_item_title() ; ?>" style="font-weight: bold; font-size: 21px; " ><?php echo osc_item_title() ; ?></a></h5>
        ...
        <div class="listing-option" style="color: #D8D8D8">
            <?php if(osc_logged_user_id()== osc_item_user_id()) { ?>
                <span  class="admin-options">
                    <a  class="edit whover" href="<?php echo osc_item_edit_url(); ?>" rel="nofollow"><i class="fa fa-pencil"></i> <?php _e('Edit ', 'flatter'); ?></a>
